                ...
                <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
                    <div className="flex gap-5 flex-wrap items-center justify-between">
                        <p className="text-dark font-medium">
                            &copy; {year}. All rights reserved by <a href="https://pimjo.com/" target="_blank" className="text-green-dark">PimjoLabs</a> • Distributed by <a href="https://themewagon.com" target="_blank" className="text-green-dark">ThemeWagon</a>
                        </p>
